...
var colors = ['#FFFFFF', '#2196F3', '#4CAF50', '#FF9800', '#009688', '#795548']; // исходная функция генерации индекса
...
var myColorChanger = new ColorChanger({
  startBtn: refs.startBtnEl
});
refs.startBtnEl.addEventListener('click', myColorChanger.start.bind(myColorChanger));
refs.stopBtnEl.addEventListener('click', myColorChanger.stop.bind(myColorChanger));
